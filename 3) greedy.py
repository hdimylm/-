...
while True:
        ...
        if choice == 1:
            print("\nPrim's MST Weight:", g.prim_mst())

        elif choice == 2:
            print("\nKruskal's MST Weight:", g.kruskal_mst())
        
        elif choice == 3:
            print("\nShortest paths from vertex 0 using Dijkstra:", g.dijkstra_shortest_path(0))
